...
public class MicrosoftService {
    ...
    public MicrosoftSession authenticate(String code) throws AuthenticationException {
        //requireNonNull(callback);

        try {
            // Microsoft OAuth Flow
            // https://login.live.com/oauth20_authorize.srf
            // ?redirect_uri=https%3a%2f%2fsisu.xboxlive.com%2fconnect%2foauth%2fXboxLive
            // &response_type=code
            // &state=LAAAAAEB1wUYOp-Lzb_GdM_fEID2E_lgAOAMP4hMG-ELg7BMmRQDF8moQy4SNTkxZmY2Y2ZjYzdhNDdiNThjMTQ5ZjM0NWEyMDQyODYx
            ...
            //String code = callback.show(this, urlToBeTested -> OAUTH_URL_PATTERN.matcher(urlToBeTested).find(),
            //        "https://login.live.com/oauth20_authorize.srf" +
